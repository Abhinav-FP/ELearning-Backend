        ...
        <tr>
         ...
         <tr>
            <td style=" padding: 1.5rem 1rem 2rem;"> 
                <img src="https://student-teacher-platform.sgp1.digitaloceanspaces.com/booking-rescheduled-banner.png" alt="banner" style="max-width:100%;margin: auto;display: block;" />
            </td>
        </tr>
        <tr>
            <td style="padding: .1rem 1rem 1rem ;border-bottom: 1px solid rgba(0,0,0,.1)">
                <p style="font-size: 1.5rem; font-weight: bold; line-height: 1.9rem; text-align: center;color: #55844D;margin: 0 0 .6rem;">Booking Rescheduled</p> 
                ...
                <p style="font-size: 1rem;font-weight: 600;text-align: center;color:#55844D;margin-bottom:.5rem;">
                  New Schedule
                </p>
                    ...
                    <div style="border:6px solid #55844D;border-radius: 20px;">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td width="70%" style="font-size: 1rem; font-weight: 400; line-height: 1.3rem;text-align: left;color: #55844D;padding: .6rem 1.3rem;border-bottom: 1px solid #55844D;"><img src="https://student-teacher-platform.sgp1.digitaloceanspaces.com/time.png" style="max-width:100%;vertical-align: text-bottom;"> ${moment.parseZone(startDateTime).format("hh:mm A")} </td> 
                        </tr>
                    </table>
                    </div>
                </div>

                <p style="margin: 0 0 1.3rem;text-align: center;"><a href="${link}" style="background:#55844D;color:#fff;border-radius: 7px;font-size: 1.1rem;text-decoration: none;display: inline-block;padding: .8rem 1.5rem;">View Your Booking</a></p> 
                <p style="font-size: 1rem; font-weight: 400; line-height: 22px; text-align: center;color: #333333;margin: 0 0 1.5rem;">Thanks for your flexibility!</p>  
              </td>
              </tr>
              <tr>
