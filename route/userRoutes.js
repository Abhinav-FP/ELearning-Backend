const { login, updateProfile, resetPassword, GetUser, verifyEmail, ResendVerificationLink, studentSignup, teacherSignup } = require("../controller/authController");
...
router.post("/user/register", studentSignup);
router.post("/user/teacher-register", teacherSignup);
