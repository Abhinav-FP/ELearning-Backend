const { homeAdd, homefind, homeupdate, FAQAdd, faqfind, faqupdate, policycondition, GetTeacherVideo, GetTeachers, faqDelete, teacherFAQAdd, teacherfaqfind, teacherfaqupdate, teacherfaqDelete, getCommission, Privacy, getCourse } = require("../controller/HomeController");
...
router.get("/home/getCourse", getCourse);
